...
let RegistrationModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            controllers: [registrations_controller_1.RegistrationController],
            exports: [registrations_service_1.RegistrationService],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var RegistrationModule = _classThis = class {
    };
    __setFunctionName(_classThis, "RegistrationModule");
    (() => {
