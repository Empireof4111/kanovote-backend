...
let AuthController = (() => {
    ...
    let _requestPasswordReset_decorators;
    let _setNewPassword_decorators;
    ...
    (() => {
        ...
        _login_decorators = [(0, common_1.UseGuards)(local_auth_guard_1.LocalAuthGuard), (0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        ...
        _logout_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('logout'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _requestPasswordReset_decorators = [(0, common_1.Post)('request-password-reset'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _setNewPassword_decorators = [(0, common_1.Post)('set-new-password'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _refreshToken_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('refresh-token'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        ...
        __esDecorate(_classThis, null, _requestPasswordReset_decorators, { kind: "method", name: "requestPasswordReset", static: false, private: false, access: { has: obj => "requestPasswordReset" in obj, get: obj => obj.requestPasswordReset }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _setNewPassword_decorators, { kind: "method", name: "setNewPassword", static: false, private: false, access: { has: obj => "setNewPassword" in obj, get: obj => obj.setNewPassword }, metadata: _metadata }, null, _instanceExtraInitializers);
